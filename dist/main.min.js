...
!function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}(),function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),e=window.setTimeout(function(){b(c+d)},d);return a=c+d,e}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),new function(){window.g3=this,g3.html=document.getElementsByTagName("html")[0],g3.body=document.getElementsByTagName("body")[0],g3.browser_info=function(){var a,b=navigator.userAgent,c=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(c[1])?(a=/\brv[ :]+(\d+)/g.exec(b)||[],["IE",a[1]||""]):"Chrome"===c[1]&&(a=b.match(/\bOPR\/(\d+)/),null!=a)?["Opera",a[1]]:(c[1]="MSIE"===c[1]?"IE":c[1],c=c[2]?[c[1],c[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(a=b.match(/version\/(\d+)/i))&&c.splice(1,1,a[1]),c)}(),g3.addClass=function(a,b){a.classList?a.classList.add(b):a.className+=" "+b},g3.removeClass=function(a,b){a.classList?a.classList.remove(b):a.className=a.className.replace(new RegExp("(^|\\b)"+b.split(" ").join("|")+"(\\b|$)","gi")," ")},g3.hasClass=function(a,b){return a.classList?a.classList.contains(b):new RegExp("(^| )"+b+"( |$)","gi").test(a.className)},g3.blockEvent=function(a,b){a.addEventListener(b,function(a){return a.preventDefault(),a.stopPropagation(),!1})},g3.getWindowWidth=function(){return window.innerWidth||document.documentElement.clientWidth||g3.body.clientWidth},g3.getWindowHeight=function(){return window.innerHeight||document.documentElement.clientHeight||g3.body.clientHeight},g3.setStyle=function(a,b){_.each(b,function(b,c){a.style[c]=b})},g3.POST_EXCUSES=["мы","она","они","оно","я","что","все","без","безо","близ","в","во","вместо","вне","для","до","за","из","изо","из-за","из-под","к","ко","кроме","между","меж","на","над","надо","о","об","обо","от","ото","перед","передо","пред","предо","по","под","подо","при","про","ради","с","со","сквозь","среди","у","через","чрез","так","и","да","не","но","также","тоже","ни","зато","однако","же","или","либо","то","ли","а","я","он"],g3.PREV_EXCUSES=["века","в.","год","г.","года"],g3.carryUnionsHTML=function(a,b){if(a){var c=(b||a.innerHTML).replace(/ +(?= )/g,"").replace(/></g,"> <").split(" ");b="",_.each(c,function(a,d){a=a.replace(/[,;:!?()"]/g,"").replace(/<.*?>/gi,"").toLowerCase();var e="";-1!=_.indexOf(g3.POST_EXCUSES,a)?(b+=c[d],e=" "):-1!=_.indexOf(g3.PREV_EXCUSES,a)?(b=b.substr(0,b.length-1)+" "+c[d],e=" "):(b+=c[d],e=" "),d<c.length-1&&(b+=e)}),a.innerHTML=b}},g3.carryUnionsHTML2=function(a){var b=a.replace(/ +(?= )/g,"").replace(/></g,"> <").split(" ");return a="",_.each(b,function(c,d){c=c.replace(/[,;:!?()"]/g,"").replace(/<.*?>/gi,"").toLowerCase();var e="";-1!=_.indexOf(g3.POST_EXCUSES,c)?(a+=b[d],e=" "):-1!=_.indexOf(g3.PREV_EXCUSES,c)?(a=a.substr(0,a.length-1)+" "+b[d],e=" "):(a+=b[d],e=" "),d<b.length-1&&(a+=e)}),a},g3.initContent=function(a){g3.contentWidth=a.contentWidth,g3.contentHeight=a.contentHeight,g3.curZoom=1,g3.curWidth=g3.contentWidth,g3.curHeight=g3.contentHeight,g3.debugMode=a.debugMode?!0:!1,g3.domain=a.domain||"",g3.ig=document.getElementById("ig"),g3.content=document.querySelectorAll("#ig > .content")[0],a.contentWidth&&(g3.content.style.width=g3.ig.style.width=g3.contentWidth+"px"),a.contentHeight&&(g3.content.style.height=g3.ig.style.height=g3.contentHeight+"px")}},function(){var a=g3.browser_info[0].substr(0,2).toLowerCase(),b=a+g3.browser_info[1].toString();g3.addClass(g3.html,a),g3.addClass(g3.html,b)}(),new function(){g3.MOBILE_EVENTS=["tap","touchstart","touchend","touchmove","touchenter","touchleave","touchcancel"],g3.DESKTOP_EVENTS=["click","dblclick","mousedown","mouseup","mousemove","mouseover","mouseout","mouseenter","mouseleave"],g3.initMobile=function(){if(window.isMobile="ontouchstart"in window,isMobile){g3.addClass(g3.html,"mobile-device");for(var a=0,b=g3.DESKTOP_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.DESKTOP_EVENTS[a])}else for(g3.addClass(g3.html,"desktop-device"),a=0,b=g3.MOBILE_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.MOBILE_EVENTS[a])}},function(){g3.initFullScreen=function(a){function b(){var a=window.innerWidth/g3.contentWidth,b=window.innerHeight/g3.contentHeight;g3.curZoom=a>b?b:a,g3.curWidth=Math.floor(g3.contentWidth*g3.curZoom),g3.curHeight=Math.floor(g3.contentHeight*g3.curZoom);var c="scale("+g3.curZoom+")";g3.content.style.webkitTransform=c,g3.content.style.mozTransform=c,g3.content.style.msTransform=c,g3.content.style.oTransform=c,g3.content.style.transform=c,g3.content.style.top=parseInt((window.innerHeight-g3.curHeight)/2)+"px",g3.content.style.left=parseInt((window.innerWidth-g3.curWidth)/2)+"px"}g3.igFrame=window.parent.document.getElementById(a);var c=document.getElementById("full-screen");g3.ig.style.height=g3.ig.style.width=null,g3.addClass(g3.html,"full-screen"),window.addEventListener("resize",b),b();var d=document.createElement("style");d.setAttribute("type","text/css"),d.innerHTML=".ig-frame {width: "+g3.contentWidth+"px;height: "+g3.contentHeight+"px;}.full-screen {position: fixed;width: 100%;height: 100%;z-index: 100;left: 0px;top: 0px;}",window.parent.document.head.appendChild(d),g3.igFrame&&(!g3.debugMode&&g3.domain&&(document.domain=g3.domain),c&&c.addEventListener("click",function(){g3.hasClass(g3.igFrame,"full-screen")?g3.removeClass(g3.igFrame,"full-screen"):g3.addClass(g3.igFrame,"full-screen")}))}}(),g3.initSocials=function(a){_.each(a,function(b,c){a[c]=encodeURIComponent(b)}),g3.vkUrl="http://vkontakte.ru/share.php?title="+a.title+"&description="+a.desc+"&url="+a.url+"&image="+a.img+"&noparse=1",g3.fbUrl="http://www.facebook.com/sharer.php?s=100&p[title]="+a.title+"&p[summary]="+a.desc+"&p[url]="+a.url+"&p[images][0]="+a.img+"&t="+a.title+"&e="+a.desc,g3.tUrl="https://twitter.com/intent/tweet?status="+(a.sDesc||a.desc);var b=document.getElementById("vk"),c=document.getElementById("fb"),d=document.getElementById("t");b&&b.addEventListener("click",function(){window.open(g3.vkUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),c&&c.addEventListener("click",function(){window.open(g3.fbUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),d&&d.addEventListener("click",function(){window.open(g3.tUrl,"sharer","toolbar=0,status=0,width=626,height=436")})},function(){function a(){d3.selectAll(".filter .header").classed("selected",!1),D=d3.select(this).classed("selected",!0).datum()}function b(a){E.classed("disabled",!0),"na"==a.tag||"unna"==a.tag?G.classed("disabled",!1).style("left",a.position[0]+t+"px").style("top",a.position[1]+t+"px").on("click",function(){E.classed("disabled",!1).selectAll(".list .line").classed("disabled",!0);var b=a.problem;if(E.select(".title").text(b.title),b.metropolis){var c=_.findWhere(m,{id:b.metropolis});E.select(".metropolis").classed("disabled",!1).select(".val").text(c.title)}b.when&&E.select(".year").classed("disabled",!1).select(".val").text(b.when+" год"),b.square&&E.select(".square").classed("disabled",!1).select(".val").text(b.square+" км"),b.population&&E.select(".populas").classed("disabled",!1).select(".val").text(b.population+" тыс. чел."),E.select(".percents .people .inside-rect").style("width",0).style("height",0).interrupt().transition().style("width",50*b.populationPercent+"px").style("height",50*b.populationPercent+"px"),E.select(".percents .people .val").text(0).interrupt().transition().text(parseInt(100*b.populationPercent)),E.select(".percents .square .inside-rect").style("width",0).style("height",0).interrupt().transition().style("width",50*b.squarePercent+"px").style("height",50*b.squarePercent+"px"),E.select(".percents .square .val").text(parseInt(100*b.squarePercent)),b.desc?E.select(".about").text(g3.carryUnionsHTML2(b.desc)).classed("disabled",!1):E.select(".about").classed("disabled",!0)}):G.on("click",null).classed("disabled",!0)}function c(){u=d3.select("#filters").selectAll(".filter").data(w).enter().append("g").attr("class","filter").attr("transform",function(a,b){return"translate("+(B[0]+(z+A)*b)+","+B[1]+")"});var b=u.append("g").attr("class","header").each(function(a){a.header=this}).on("click",function(){a.call(this),C&&j.call(C,D.prop)});b.append("rect").attr("width",z).attr("height",20),b.append("text").attr("x",30).attr("y",14).text(function(a){return a.title});var c=10;b.append("circle").attr("class","border-point").attr("cx",c).attr("cy",c).attr("r",6),b.append("circle").attr("class","inner-circle").attr("cx",c).attr("cy",c).attr("r",3),v=u.append("g").attr("class","points").attr("transform","translate(0,"+(20+x)+")")}function d(){var a=d3.select(this).datum();v.each(function(c,e){var f=d3.nest().key(function(a){return a.tag}).entries(a[c.prop]),g=[];console.log(f);for(var h=0;h<f.length;h++)g=g.concat(f[h].values);var i=d3.select(this).selectAll(".filter-point").data(g,function(a){return a.id});i.enter().append("rect").attr("x",function(a){return a.position[0]-B[0]-e*(z+A)}).attr("y",function(a){return a.position[1]-B[1]-(20+x)}).attr("class","filter-point").attr("width",s).attr("height",s).attr("fill",function(a){return l[a.tag]}).on("click",function(a){C=a.mapPoint,d.call(this),j.call(C,D.prop),b(a)}).on("mouseover",function(a){var b=d3.mouse(d3.select(".content")[0][0]);F.text(a.title).style("left",b[0]+H+"px").style("top",b[1]+H+"px").classed("disabled",!1)}).on("mouseout",function(){F.classed("disabled",!0)}),i.transition().duration(function(){return 300+200*Math.random()}).attr("x",function(a,b){return b%y*(s+x)+"px"}).attr("y",function(a,b){return parseInt(b/y)*(s+x)+"px"}).style("opacity",1),i.exit().transition().duration(function(){return 300+200*Math.random()}).attr("x",function(){return-500+2e3*Math.random()}).attr("y",function(){return-500+1e3*Math.random()}).style("opacity",0).remove()})}function e(a){_.each(a,function(a){_.each(a.approveList,function(b){b.approvedList.push(a)}),_.each(a.negativeList,function(b){b.negativedList.push(a)})})}function f(a){_.each(a,function(b){if(b.approveList.length>0)b.negativeList=g(a,b.approveList,b.id);else if(b.negativeList.length>0)b.approveList=g(a,b.negativeList,b.id);else if(-1!=b.tag.indexOf("na")){var c=[];_.each(a,function(a){-1!=a.tag.indexOf("un")&&b.id!=a.id&&c.push(a)}),b.negativeList=c}})}function g(a,b,c){var d=[],e=0;for(a.length;e<a.length;e++){var f=a[e],g=!0;if(-1!=f.tag.indexOf("un")&&f.id!=c){for(var h=0,i=b.length;i>h;h++)if(f.id==b[h].id){g=!1;break}g&&d.push(f)}}return d}function h(a,b){return _.each(a,function(c,d){var e=_.findWhere(b,{id:c});e?a[d]=e:console.log(a,c)}),a}function i(a){var b=[];return _.each(a,function(a){_.each(a.borderList,function(c){for(var d=!0,e=0;e<b.length;e++){{b[e]}if(b[e][0]==c.id&&b[e][1]==a.id||b[e][0]==a.id&&b[e][1]==c.id){d=!1;break}}d&&b.push([a,c])})}),b}function j(a){var b=this.datum();r.html("").selectAll("line").data(b[a]).enter().append("line").attr("class","approve-line").attr("x1",b.position[0]+t).attr("x2",function(a){return a.position[0]+t}).attr("y1",b.position[1]+t).attr("y2",function(a){return a.position[1]+t})}function k(){p.selectAll("line").data(o).enter().append("line").attr("class","border-line").attr("x1",function(a){return a[0].position[0]+t}).attr("x2",function(a){return a[1].position[0]+t}).attr("y1",function(a){return a[0].position[1]+t}).attr("y2",function(a){return a[1].position[1]+t})}g3.initContent({contentWidth:1280,contentHeight:720,domain:"lenta.ru",debugMode:!0});var l={un:"#A1A4A7",unna:"#FFC519",na:"#F3740D"},m=null,n=null,o=null,p=d3.select("#borders"),q=d3.selectAll("#rects rect"),r=d3.select("#links"),s=5,t=s/2,u=null,v=null,w=[{title:"Кто признаёт",prop:"approveList"},{title:"Кто не признаёт",prop:"negativeList"},{title:"Кого признаёт",prop:"approvedList"},{title:"Кого не признаёт",prop:"negativedList"}],x=2,y=20,z=(s+x)*y-x,A=30,B=[1280-w.length*(z+A)+40-A,20],C=null,D=null,E=d3.select(".problem-popup"),F=d3.select(".popup"),G=d3.select(".na-info.btn"),H=10;E.on("click",function(){E.classed("disabled",!0)}),d3.tsv("data.csv",function(a){m=a,d3.tsv("problems.csv",function(a){_.each(m,function(a){a.mapPoint=d3.select("#"+a.id),a.mapPoint.datum(a).style("fill",l[a.tag.toLowerCase()]),a.position=[+a.mapPoint.attr("x"),+a.mapPoint.attr("y")],a.tag=a.tag.toLowerCase(),a.borderList=a.borderList?h(a.borderList.replace(/\s{1,}/g,"").split(","),m):[],a.approveList=a.approveList?h(a.approveList.replace(/\s{1,}/g,"").split(","),m):[],a.negativeList=a.negativeList?h(a.negativeList.replace(/\s{1,}/g,"").split(","),m):[],a.approvedList=[],a.negativedList=[]}),f(m),e(m),_.each(a,function(a){a.square=+a.square,a.metropolisSquare=+a.metropolisSquare,a.population=+a.population,a.metropolisPopulation=+a.metropolisPopulation,a.squarePercent=a.metropolisSquare?a.square/a.metropolisSquare:0,a.populationPercent=a.metropolisPopulation?a.population/a.metropolisPopulation:0;var b=_.findWhere(m,{id:a.id});b?b.problem=a:console.log("problem id = ",a.id)}),console.log(m),o=i(m),n=d3.nest().key(function(a){return a.tag}).entries(m),q.on("click",function(a){C=d3.select(this),j.call(C,D.prop),d.call(this),b(a)}).on("mouseover",function(a){var b=d3.mouse(this);F.text(a.title).style("left",b[0]+H+"px").style("top",b[1]+H+"px").classed("disabled",!1)}).on("mouseout",function(){F.classed("disabled",!0)}),k()})}),c(),console.log(w),a.call(w[0].header)}();