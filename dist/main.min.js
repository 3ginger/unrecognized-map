...
!function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}(),function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),e=window.setTimeout(function(){b(c+d)},d);return a=c+d,e}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),new function(){window.g3=this,g3.html=document.getElementsByTagName("html")[0],g3.body=document.getElementsByTagName("body")[0],g3.browser_info=function(){var a,b=navigator.userAgent,c=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(c[1])?(a=/\brv[ :]+(\d+)/g.exec(b)||[],["IE",a[1]||""]):"Chrome"===c[1]&&(a=b.match(/\bOPR\/(\d+)/),null!=a)?["Opera",a[1]]:(c[1]="MSIE"===c[1]?"IE":c[1],c=c[2]?[c[1],c[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(a=b.match(/version\/(\d+)/i))&&c.splice(1,1,a[1]),c)}(),g3.addClass=function(a,b){a.classList?a.classList.add(b):a.className+=" "+b},g3.removeClass=function(a,b){a.classList?a.classList.remove(b):a.className=a.className.replace(new RegExp("(^|\\b)"+b.split(" ").join("|")+"(\\b|$)","gi")," ")},g3.hasClass=function(a,b){return a.classList?a.classList.contains(b):new RegExp("(^| )"+b+"( |$)","gi").test(a.className)},g3.blockEvent=function(a,b){a.addEventListener(b,function(a){return a.preventDefault(),a.stopPropagation(),!1})},g3.getWindowWidth=function(){return window.innerWidth||document.documentElement.clientWidth||g3.body.clientWidth},g3.getWindowHeight=function(){return window.innerHeight||document.documentElement.clientHeight||g3.body.clientHeight},g3.setStyle=function(a,b){_.each(b,function(b,c){a.style[c]=b})},g3.POST_EXCUSES=["мы","она","они","оно","я","что","все","без","безо","близ","в","во","вместо","вне","для","до","за","из","изо","из-за","из-под","к","ко","кроме","между","меж","на","над","надо","о","об","обо","от","ото","перед","передо","пред","предо","по","под","подо","при","про","ради","с","со","сквозь","среди","у","через","чрез","так","и","да","не","но","также","тоже","ни","зато","однако","же","или","либо","то","ли","а","я","он"],g3.PREV_EXCUSES=["века","в.","год","г.","года"],g3.carryUnionsHTML=function(a,b){if(a){var c=(b||a.innerHTML).replace(/ +(?= )/g,"").replace(/></g,"> <").split(" ");b="",_.each(c,function(a,d){a=a.replace(/[,;:!?()"]/g,"").replace(/<.*?>/gi,"").toLowerCase();var e="";-1!=_.indexOf(g3.POST_EXCUSES,a)?(b+=c[d],e=" "):-1!=_.indexOf(g3.PREV_EXCUSES,a)?(b=b.substr(0,b.length-1)+" "+c[d],e=" "):(b+=c[d],e=" "),d<c.length-1&&(b+=e)}),a.innerHTML=b}},g3.initContent=function(a){g3.contentWidth=a.contentWidth,g3.contentHeight=a.contentHeight,g3.curZoom=1,g3.curWidth=g3.contentWidth,g3.curHeight=g3.contentHeight,g3.debugMode=a.debugMode?!0:!1,g3.domain=a.domain||"",g3.ig=document.getElementById("ig"),g3.content=document.querySelectorAll("#ig > .content")[0],a.contentWidth&&(g3.content.style.width=g3.ig.style.width=g3.contentWidth+"px"),a.contentHeight&&(g3.content.style.height=g3.ig.style.height=g3.contentHeight+"px")}},function(){var a=g3.browser_info[0].substr(0,2).toLowerCase(),b=a+g3.browser_info[1].toString();g3.addClass(g3.html,a),g3.addClass(g3.html,b)}(),new function(){g3.MOBILE_EVENTS=["tap","touchstart","touchend","touchmove","touchenter","touchleave","touchcancel"],g3.DESKTOP_EVENTS=["click","dblclick","mousedown","mouseup","mousemove","mouseover","mouseout","mouseenter","mouseleave"],g3.initMobile=function(){if(window.isMobile="ontouchstart"in window,isMobile){g3.addClass(g3.html,"mobile-device");for(var a=0,b=g3.DESKTOP_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.DESKTOP_EVENTS[a])}else for(g3.addClass(g3.html,"desktop-device"),a=0,b=g3.MOBILE_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.MOBILE_EVENTS[a])}},function(){g3.initFullScreen=function(a){function b(){var a=window.innerWidth/g3.contentWidth,b=window.innerHeight/g3.contentHeight;g3.curZoom=a>b?b:a,g3.curWidth=Math.floor(g3.contentWidth*g3.curZoom),g3.curHeight=Math.floor(g3.contentHeight*g3.curZoom);var c="scale("+g3.curZoom+")";g3.content.style.webkitTransform=c,g3.content.style.mozTransform=c,g3.content.style.msTransform=c,g3.content.style.oTransform=c,g3.content.style.transform=c,g3.content.style.top=parseInt((window.innerHeight-g3.curHeight)/2)+"px",g3.content.style.left=parseInt((window.innerWidth-g3.curWidth)/2)+"px"}g3.igFrame=window.parent.document.getElementById(a);var c=document.getElementById("full-screen");g3.ig.style.height=g3.ig.style.width=null,g3.addClass(g3.html,"full-screen"),window.addEventListener("resize",b),b();var d=document.createElement("style");d.setAttribute("type","text/css"),d.innerHTML=".ig-frame {width: "+g3.contentWidth+"px;height: "+g3.contentHeight+"px;}.full-screen {position: fixed;width: 100%;height: 100%;z-index: 100;left: 0px;top: 0px;}",window.parent.document.head.appendChild(d),g3.igFrame&&(!g3.debugMode&&g3.domain&&(document.domain=g3.domain),c&&c.addEventListener("click",function(){g3.hasClass(g3.igFrame,"full-screen")?g3.removeClass(g3.igFrame,"full-screen"):g3.addClass(g3.igFrame,"full-screen")}))}}(),g3.initSocials=function(a){_.each(a,function(b,c){a[c]=encodeURIComponent(b)}),g3.vkUrl="http://vkontakte.ru/share.php?title="+a.title+"&description="+a.desc+"&url="+a.url+"&image="+a.img+"&noparse=1",g3.fbUrl="http://www.facebook.com/sharer.php?s=100&p[title]="+a.title+"&p[summary]="+a.desc+"&p[url]="+a.url+"&p[images][0]="+a.img+"&t="+a.title+"&e="+a.desc,g3.tUrl="https://twitter.com/intent/tweet?status="+(a.sDesc||a.desc);var b=document.getElementById("vk"),c=document.getElementById("fb"),d=document.getElementById("t");b&&b.addEventListener("click",function(){window.open(g3.vkUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),c&&c.addEventListener("click",function(){window.open(g3.fbUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),d&&d.addEventListener("click",function(){window.open(g3.tUrl,"sharer","toolbar=0,status=0,width=626,height=436")})},new function(){},new function(){g3.initParallax=function(a){function b(a){J=parseInt(a>E?E:0>a?0:a),window.scrollTo(0,J)}function c(){v=!0;var a=F/E,b=I/E;E=1,z=-1,A=0,G=0,D=g3.getWindowWidth(),C=g3.getWindowHeight(),h(),I=parseInt(b*E),F=parseInt(a*E),g3.body.style.height=E+"px",window.scrollTo(0,F),g()}function d(){window.requestAnimationFrame(function(){e(),u&&f(y,G)})}function e(){var a=isMobile?M:window.pageYOffset;if(v||a!=F){u=!0,v=!1,H=a>F?1:F>a?-1:0;var b=-1;if(y.stopPointsY)for(var c=0,d=y.stopPointsY.length;d-1>c;c++){var e=y.stopPointsY[c]+y.offsetTimeY,f=y.stopPointsY[c+1]+y.offsetTimeY;if(F>e&&f>F){1==H?b=f:-1==H&&(b=e);break}}b>-1&&(b=parseInt(b),a=b);var h=a-F,i=parseInt(h/n);i=i>p?p:i,i>0?i=o>i?o:i:0>i&&(i=i>-o?-o:i),0==i?F=a:F+=i,u&&(window.scrollTo(0,a),J=a,g(),G=F-A)}else u=!1}function f(a,b){_.each(a.objects,function(c){var d={};_.each(c.phasesValues,function(e,f){var g=null,h=null,i=null,j=null;if(_.each(e,function(a){null==h&&b>=a.id?(g=a.val,i=a.id):null!=g&&null==h&&b<a.id&&(h=a.val,j=a.id)}),"callbacks"==f)_.each(c.phasesValues[f],function(c){c.call(this,a,F/E,b/a.timeY,z,B,H)});else if("classes"==f)_.each(c.phasesValues[f],function(a,d){var e=null,f=!1;_.each(a,function(a){f||(b>=a.id&&(e=a.val),b<a.id&&(f=!0,"add"==e?_.each(c.$obj,function(a){g3.addClass(a,d)}):"remove"==e&&_.each(c.$obj,function(a){g3.removeClass(a,d)})))})});else{var k=null;if(null!=g&&null!=h){var l=h-g;k=g+(b-i)/(j-i)*l}else null==g?k=e[0].val:null==h&&(k=e[e.length-1].val);d[f]=k}});var e="translate(-xpx,-ypx) scale(-scale) rotate(-rotatedeg)",f={};_.each(d,function(a,b){"x"==b?e=e.replace("-x",parseInt(a)):"y"==b?e=e.replace("-y",parseInt(a)):"scale"==b?e=e.replace("-scale",a):"rotate"==b?e=e.replace("-rotate",a):f[b]=a}),e=e.replace("-x","0"),e=e.replace("-y","0"),e=e.replace("-scale","1"),e=e.replace("-rotate","0"),f["-webkit-transform"]=e,f["-moz-transform"]=e,f["-ms-transform"]=e,f["-o-transform"]=e,f.transform=e,_.each(c.$obj,function(a){g3.setStyle(a,f)})})}function g(){for(var a=0,b=k.length;b>a;a++){var c=k[a];if(F>=c.offsetTimeY&&F<c.endOffsetTimeY){i(c.id);break}}}function h(){_.each(k,function(a,b){if(a.timeY=0,a.offsetTimeY=0,a.stopPointsY=a.stopPointsY||[],a.stopPointsY.length=0,a.id=b,!t){var c=[];_.isArray(a.view)?_.each(a.view,function(a){a&&_.each(document.querySelectorAll(a),function(a){c.push(a)})}):a&&_.each(document.querySelectorAll(a),function(a){c.push(a)}),w.push(c),_.each(a.objects,function(a){var b=[];_.each(a.phases,function(a){b=_.union(b,_.filter(_.keys(a),function(a){return"id"!=a}))}),a.keys=b})}a.offsetTimeY=E,E+=a.timeY=parseInt(j(a.time,"y")),a.endOffsetTimeY=a.offsetTimeY+a.timeY,_.each(a.stopPoints,function(b){a.stopPointsY.push(j(b,"y",a.timeY))}),_.each(a.objects,function(b){b.$obj=document.querySelectorAll(b.id),b.phasesValues={classes:{},callbacks:[]},_.each(b.phases,function(c){_.each(b.keys,function(d){function e(a){_.isFunction(a)&&-1==_.indexOf(a,f)&&f.push(a)}if(void 0!=c[d]){var f=null;if(b.phasesValues[d]||(b.phasesValues[d]=[]),f=b.phasesValues[d],"callbacks"==d)_.isArray(c[d])?_.each(c[d],function(a){e(a)}):e(c[d]);else if("classes"==d)_.each(c[d].split(" "),function(b){var d=null;f[b]||(f[b]=[],f[b].push({id:0,val:"remove"}),f[b].push({id:parseInt(j("100%","y",a.timeY)),val:"remove"})),d=f[b];var e=d[d.length-2],g=parseInt(j(c.id,"y",a.timeY)),h="add"==e.val?"remove":"add";if(g==e.id)e.val=h;else if(g>e.id){var i={id:g,val:h};d.splice(d.length-1,0,i),e=i}});else{var g=j(c[d],d);-1==_.indexOf(N,d)&&(g=parseInt(g)),f.push({id:j(c.id,"y",a.timeY),val:g})}}})})})})}function i(a,b){a!=z&&(b=b||!1,B=z,z=a,y=k[z],A=y.offsetTimeY,_.each(x,function(a){a.style.display="none"}),_.each(w[z],function(a){a.style.display="block"}),b&&(e(),f()))}function j(a,b,c){return"string"==typeof a&&a.match(/%/g)&&(a=parseFloat(a)/100,b=b||"x",c=c||("x"==b?D:C),a*=c),parseFloat(a)}var k=a.keyFrames||[],l=a.frameRate||60,m=a.mobileFrameRate||l,n=a.animationSmooth||10,o=a.minScrollAnimate||10,p=a.maxScrollAnimate||100,q=g3.browser_info[0],r=a.keyElements||[".slide",".cover"],s=1;isMobile?(s=2,document.addEventListener("touchstart",function(a){if(1==a.touches.length){var b=a.touches[0];L=b.pageY,K=!0}return a.preventDefault(),a.stopPropagation(),!1}),document.addEventListener("touchend touchleave",function(a){a.touches[0];return L=0,K=!1,a.preventDefault(),a.stopPropagation(),!1}),document.addEventListener("touchmove",function(a){if(K){var c=a.touches[0].pageY,d=L-c;b(J+d),L=c}})):"Firefox"==q?(s=33,g3.body.addEventListener("DOMMouseScroll",function(a){b(J+a.detail*s)})):"IE"==q||"Safari"==q?g3.body.addEventListener("mousewheel",function(a){return s=.84,b(J-a.wheelDelta*s),a.preventDefault(),!1}):g3.body.addEventListener("mousewheel",function(a){b(J+a.deltaY*s)});var t=!1,u=!1,v=!1,w=[],x=null,y=null,z=-1,A=0,B=-1,C=0,D=0,E=1,F=0,G=0,H=0,I=0,J=0,K=!1,L=0,M=0,N=["x","y","rotate","left","right","top","bottom","height"];g3.getKeyframeIndex=function(){return z},g3.getKeyframeLabel=function(){return y.label||z},x=[],_.each(r,function(a){_.each(document.querySelectorAll(a),function(a){x.push(a)})}),g3.addClass(g3.html,"parallax"),k.length>0&&(window.addEventListener("resize",c),c(),setInterval(d,1e3/(isMobile?m:l)),i(0),t=!0),g3.changeKeyFrame=function(a,b){function c(a){v=!0,window.scrollTo(0,a),J=a,b&&(F=a)}if(b=b||!1,_.isString(a)){var d=_.findWhere(k,{label:a});c(d.offsetTimeY)}else a>=0&&a<k.length&&c(k[a].offsetTimeY)}}},function(){function a(){d3.selectAll(".filter .header").classed("selected",!1),C=d3.select(this).classed("selected",!0).datum()}function b(){t=d3.select("#filters").selectAll(".filter").data(v).enter().append("g").attr("class","filter").attr("transform",function(a,b){return"translate("+(A[0]+(y+z)*b)+","+A[1]+")"});var b=t.append("g").attr("class","header").each(function(a){a.header=this}).on("click",function(){a.call(this),B&&i.call(B,C.prop)});b.append("rect").attr("width",y).attr("height",20),b.append("text").attr("x",30).attr("y",14).text(function(a){return a.title});var c=10;b.append("circle").attr("class","border-point").attr("cx",c).attr("cy",c).attr("r",6),b.append("circle").attr("class","inner-circle").attr("cx",c).attr("cy",c).attr("r",3),u=t.append("g").attr("class","points").attr("transform","translate(0,"+(20+w)+")")}function c(){var a=d3.select(this).datum();u.each(function(b,d){var e=d3.nest().key(function(a){return a.tag}).entries(a[b.prop]),f=[];console.log(e);for(var g=0;g<e.length;g++)f=f.concat(e[g].values);var h=d3.select(this).selectAll(".filter-point").data(f,function(a){return a.id});h.enter().append("rect").attr("x",function(a){return a.position[0]-A[0]-d*(y+z)}).attr("y",function(a){return a.position[1]-A[1]-(20+w)}).attr("class","filter-point").attr("width",r).attr("height",r).attr("fill",function(a){return k[a.tag]}).on("click",function(a){B=a.mapPoint,c.call(this),i.call(B,C.prop)}),h.transition().duration(function(){return 300+200*Math.random()}).attr("x",function(a,b){return b%x*(r+w)+"px"}).attr("y",function(a,b){return parseInt(b/x)*(r+w)+"px"}).style("opacity",1),h.exit().transition().duration(function(){return 300+200*Math.random()}).attr("x",function(){return-500+2e3*Math.random()}).attr("y",function(){return-500+1e3*Math.random()}).style("opacity",0).remove()})}function d(a){_.each(a,function(a){_.each(a.approveList,function(b){b.approvedList.push(a)}),_.each(a.negativeList,function(b){b.negativedList.push(a)})})}function e(a){_.each(a,function(b){if(b.approveList.length>0)b.negativeList=f(a,b.approveList,b.id);else if(b.negativeList.length>0)b.approveList=f(a,b.negativeList,b.id);else if(-1!=b.tag.indexOf("na")){var c=[];_.each(a,function(a){-1!=a.tag.indexOf("un")&&b.id!=a.id&&c.push(a)}),b.negativeList=c}})}function f(a,b,c){var d=[],e=0;for(a.length;e<a.length;e++){var f=a[e],g=!0;if(-1!=f.tag.indexOf("un")&&f.id!=c){for(var h=0,i=b.length;i>h;h++)if(f.id==b[h].id){g=!1;break}g&&d.push(f)}}return d}function g(a,b){return _.each(a,function(c,d){var e=_.findWhere(b,{id:c});e?a[d]=e:console.log(a,c)}),a}function h(a){var b=[];return _.each(a,function(a){_.each(a.borderList,function(c){for(var d=!0,e=0;e<b.length;e++){{b[e]}if(b[e][0]==c.id&&b[e][1]==a.id||b[e][0]==a.id&&b[e][1]==c.id){d=!1;break}}d&&b.push([a,c])})}),b}function i(a){var b=this.datum();q.html("").selectAll("line").data(b[a]).enter().append("line").attr("class","approve-line").attr("x1",b.position[0]+s).attr("x2",function(a){return a.position[0]+s}).attr("y1",b.position[1]+s).attr("y2",function(a){return a.position[1]+s})}function j(){o.selectAll("line").data(n).enter().append("line").attr("class","border-line").attr("x1",function(a){return a[0].position[0]+s}).attr("x2",function(a){return a[1].position[0]+s}).attr("y1",function(a){return a[0].position[1]+s}).attr("y2",function(a){return a[1].position[1]+s})}g3.initContent({contentWidth:1280,contentHeight:720,domain:"lenta.ru",debugMode:!0});var k={un:"#A1A4A7",unna:"#FFC519",na:"#F3740D"},l=null,m=null,n=null,o=d3.select("#borders"),p=d3.selectAll("#rects rect"),q=d3.select("#links"),r=5,s=r/2,t=null,u=null,v=[{title:"Признали",prop:"approveList"},{title:"Не признали",prop:"negativeList"},{title:"Признают",prop:"approvedList"},{title:"Не признают",prop:"negativedList"}],w=2,x=20,y=(r+w)*x-w,z=30,A=[1280-v.length*(y+z)+40-z,20],B=null,C=null;d3.tsv("data.csv",function(a){l=a,_.each(a,function(b){b.mapPoint=d3.select("#"+b.id),b.mapPoint.datum(b).style("fill",k[b.tag.toLowerCase()]),b.position=[+b.mapPoint.attr("x"),+b.mapPoint.attr("y")],b.tag=b.tag.toLowerCase(),b.borderList=b.borderList?g(b.borderList.replace(/\s{1,}/g,"").split(","),a):[],b.approveList=b.approveList?g(b.approveList.replace(/\s{1,}/g,"").split(","),a):[],b.negativeList=b.negativeList?g(b.negativeList.replace(/\s{1,}/g,"").split(","),a):[],b.approvedList=[],b.negativedList=[]}),e(a),d(a),console.log(l),n=h(a),m=d3.nest().key(function(a){return a.tag}).entries(a),p.on("click",function(){B=d3.select(this),i.call(B,C.prop),c.call(this)}),j()}),b(),console.log(v),a.call(v[0].header)}();