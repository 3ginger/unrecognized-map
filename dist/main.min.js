...
!function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}(),function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-a)),e=window.setTimeout(function(){b(c+d)},d);return a=c+d,e}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),new function(){window.g3=this,g3.html=document.getElementsByTagName("html")[0],g3.body=document.getElementsByTagName("body")[0],g3.browser_info=function(){var a,b=navigator.userAgent,c=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(c[1])?(a=/\brv[ :]+(\d+)/g.exec(b)||[],["IE",a[1]||""]):"Chrome"===c[1]&&(a=b.match(/\bOPR\/(\d+)/),null!=a)?["Opera",a[1]]:(c[1]="MSIE"===c[1]?"IE":c[1],c=c[2]?[c[1],c[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(a=b.match(/version\/(\d+)/i))&&c.splice(1,1,a[1]),c)}(),g3.addClass=function(a,b){a.classList?a.classList.add(b):a.className+=" "+b},g3.removeClass=function(a,b){a.classList?a.classList.remove(b):a.className=a.className.replace(new RegExp("(^|\\b)"+b.split(" ").join("|")+"(\\b|$)","gi")," ")},g3.hasClass=function(a,b){return a.classList?a.classList.contains(b):new RegExp("(^| )"+b+"( |$)","gi").test(a.className)},g3.blockEvent=function(a,b){a.addEventListener(b,function(a){return a.preventDefault(),a.stopPropagation(),!1})},g3.getWindowWidth=function(){return window.innerWidth||document.documentElement.clientWidth||g3.body.clientWidth},g3.getWindowHeight=function(){return window.innerHeight||document.documentElement.clientHeight||g3.body.clientHeight},g3.setStyle=function(a,b){_.each(b,function(b,c){a.style[c]=b})},g3.POST_EXCUSES=["их","мы","она","они","оно","я","что","все","без","безо","близ","в","во","вместо","вне","для","до","за","из","изо","из-за","из-под","к","ко","кроме","между","меж","на","над","надо","о","об","обо","от","ото","перед","передо","пред","предо","по","под","подо","при","про","ради","с","со","сквозь","среди","у","через","чрез","так","и","да","не","но","также","тоже","ни","зато","однако","же","или","либо","то","ли","а","я","он"],g3.PREV_EXCUSES=["века","в.","год","г.","года"],g3.carryUnionsHTML=function(a,b){if(a){var c=(b||a.innerHTML).replace(/ +(?= )/g,"").replace(/></g,"> <").split(" ");b="",_.each(c,function(a,d){a=a.replace(/[,;:!?()"]/g,"").replace(/<.*?>/gi,"").toLowerCase();var e="";-1!=_.indexOf(g3.POST_EXCUSES,a)?(b+=c[d],e=" "):-1!=_.indexOf(g3.PREV_EXCUSES,a)?(b=b.substr(0,b.length-1)+" "+c[d],e=" "):(b+=c[d],e=" "),d<c.length-1&&(b+=e)}),a.innerHTML=b}},g3.carryUnionsHTML2=function(a){var b=a.replace(/ +(?= )/g,"").replace(/></g,"> <").split(" ");return a="",_.each(b,function(c,d){c=c.replace(/[,;:!?()"]/g,"").replace(/<.*?>/gi,"").toLowerCase();var e="";-1!=_.indexOf(g3.POST_EXCUSES,c)?(a+=b[d],e=" "):-1!=_.indexOf(g3.PREV_EXCUSES,c)?(a=a.substr(0,a.length-1)+" "+b[d],e=" "):(a+=b[d],e=" "),d<b.length-1&&(a+=e)}),a},g3.initContent=function(a){g3.contentWidth=a.contentWidth,g3.contentHeight=a.contentHeight,g3.curZoom=1,g3.curWidth=g3.contentWidth,g3.curHeight=g3.contentHeight,g3.debugMode=a.debugMode?!0:!1,g3.domain=a.domain||"",g3.ig=document.getElementById("ig"),g3.content=document.querySelectorAll("#ig > .content")[0],a.contentWidth&&(g3.content.style.width=g3.ig.style.width=g3.contentWidth+"px"),a.contentHeight&&(g3.content.style.height=g3.ig.style.height=g3.contentHeight+"px")}},function(){var a=g3.browser_info[0].substr(0,2).toLowerCase(),b=a+g3.browser_info[1].toString();g3.addClass(g3.html,a),g3.addClass(g3.html,b)}(),new function(){g3.MOBILE_EVENTS=["tap","touchstart","touchend","touchmove","touchenter","touchleave","touchcancel"],g3.DESKTOP_EVENTS=["click","dblclick","mousedown","mouseup","mousemove","mouseover","mouseout","mouseenter","mouseleave"],g3.initMobile=function(){if(window.isMobile="ontouchstart"in window,isMobile){g3.addClass(g3.html,"mobile-device");for(var a=0,b=g3.DESKTOP_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.DESKTOP_EVENTS[a])}else for(g3.addClass(g3.html,"desktop-device"),a=0,b=g3.MOBILE_EVENTS.length;b>a;a++)g3.blockEvent(document,g3.MOBILE_EVENTS[a])}},function(){g3.initFullScreen=function(a){function b(){var a=window.innerWidth/g3.contentWidth,b=window.innerHeight/g3.contentHeight;g3.curZoom=a>b?b:a,g3.curWidth=Math.floor(g3.contentWidth*g3.curZoom),g3.curHeight=Math.floor(g3.contentHeight*g3.curZoom);var c="scale("+g3.curZoom+")";g3.content.style.webkitTransform=c,g3.content.style.mozTransform=c,g3.content.style.msTransform=c,g3.content.style.oTransform=c,g3.content.style.transform=c,g3.content.style.top=parseInt((window.innerHeight-g3.curHeight)/2)+"px",g3.content.style.left=parseInt((window.innerWidth-g3.curWidth)/2)+"px"}g3.igFrame=window.parent.document.getElementById(a);var c=document.getElementById("full-screen");g3.ig.style.height=g3.ig.style.width=null,g3.addClass(g3.html,"full-screen"),window.addEventListener("resize",b),b();var d=document.createElement("style");d.setAttribute("type","text/css"),d.innerHTML=".ig-frame {width: "+g3.contentWidth+"px;height: "+g3.contentHeight+"px;}.full-screen {position: fixed;width: 100%;height: 100%;z-index: 100;left: 0px;top: 0px;}",window.parent.document.head.appendChild(d),g3.igFrame&&(!g3.debugMode&&g3.domain&&(document.domain=g3.domain),c&&c.addEventListener("click",function(){g3.hasClass(g3.igFrame,"full-screen")?g3.removeClass(g3.igFrame,"full-screen"):g3.addClass(g3.igFrame,"full-screen")}))}}(),g3.initSocials=function(a){_.each(a,function(b,c){a[c]=encodeURIComponent(b)}),g3.vkUrl="http://vkontakte.ru/share.php?title="+a.title+"&description="+a.desc+"&url="+a.url+"&image="+a.img+"&noparse=1",g3.fbUrl="http://www.facebook.com/sharer.php?s=100&p[title]="+a.title+"&p[summary]="+a.desc+"&p[url]="+a.url+"&p[images][0]="+a.img+"&t="+a.title+"&e="+a.desc,g3.tUrl="https://twitter.com/intent/tweet?status="+(a.sDesc||a.desc);var b=document.getElementById("vk"),c=document.getElementById("fb"),d=document.getElementById("t");b&&b.addEventListener("click",function(){window.open(g3.vkUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),c&&c.addEventListener("click",function(){window.open(g3.fbUrl,"sharer","toolbar=0,status=0,width=626,height=436")}),d&&d.addEventListener("click",function(){window.open(g3.tUrl,"sharer","toolbar=0,status=0,width=626,height=436")})},function(){function a(a){function b(a){return a*a}function d(){o++,l(),k.call(I,J.prop),P>o&&setTimeout(function(){d()},1e3/60)}S[0][0].value=a.title,_.each(m,function(a){a.mapPoint.interrupt().transition().duration(200+100*Math.random()).attr("x",a.position[0]).attr("y",a.position[1])}),m=_.filter(r,function(c){if(c!=a){var d=Math.sqrt(b(a.position[0]-c.position[0])+b(a.position[1]-c.position[1]));if(O>d)return c.reboundK=O/d,c.curDistance=d,!0}return!1}),_.each(m,function(b){var c=b.position[0]-a.position[0],d=b.position[1]-a.position[1],e=[a.position[0]+c*b.reboundK,a.position[1]+d*b.reboundK];b.mapPoint.interrupt().transition().duration(200+100*Math.random()).attr("x",e[0]).attr("y",e[1])}),I=d3.select(this),n&&window.cancelAnimationFrame(n),n=window.requestAnimationFrame(function(){o=0,d()}),e.call(this),c(a)}function b(){d3.selectAll(".filter .header").classed("selected",!1),J=d3.select(this).classed("selected",!0).datum()}function c(a){K.classed("disabled",!0),"na"==a.tag||"unna"==a.tag?M.classed("disabled",!1).style("left",a.position[0]+y+"px").style("top",a.position[1]+y+"px").on("click",function(){function b(a){return 1>a?"<1":a}function c(a){K.selectAll(".pager .page").classed("selected",!1);d3.select(this).classed("selected",!0);d3.select(K.selectAll(".about .desc").classed("disabled",!0)[0][a]).classed("disabled",!1),d3.event.stopPropagation()}K.classed("disabled",!1).selectAll(".list .line").classed("disabled",!0);var d=a.problem;if(K.select(".title").text(d.title),d.metropolis){var e=_.findWhere(r,{id:d.metropolis});K.select(".metropolis").classed("disabled",!1).select(".val").text(e.title)}d.when&&K.select(".year").classed("disabled",!1).select(".val").text(d.when+" год"),d.square&&K.select(".square").classed("disabled",!1).select(".val").text(d.square+" км"),d.population&&K.select(".populas").classed("disabled",!1).select(".val").text(d.population+" тыс. чел."),null!=d.populationPercent?(K.select(".percents .people").classed("disabled",!1),K.select(".percents .people .inside-rect").style("width",0).style("height",0).interrupt().transition().style("width",50*d.populationPercent+"px").style("height",50*d.populationPercent+"px"),K.select(".percents .people .val").text(0).interrupt().transition().text(b(parseInt(Math.floor(100*d.populationPercent))))):K.select(".percents .people").classed("disabled",!0),null!=d.populationPercent?(K.select(".percents .square").classed("disabled",!1),K.select(".percents .square .inside-rect").style("width",0).style("height",0).interrupt().transition().style("width",50*d.squarePercent+"px").style("height",50*d.squarePercent+"px"),K.select(".percents .square .val").text(b(parseInt(Math.floor(100*d.squarePercent))))):K.select(".percents .square").classed("disabled",!0),d.desc?(K.select(".about").html("").classed("disabled",!1).selectAll(".desc").data(d.desc).enter().append("div").attr("class","desc").text(function(a){return g3.carryUnionsHTML2(a)}).classed("disabled",!1),d.desc.length>1?(K.select(".pager").html("").classed("disabled",!1).style("width",12*d.desc.length*2-12+"px").selectAll(".page").data(d.desc).enter().append("div").attr("class","page btn").classed("selected",!1).on("click",function(a,b){c.call(this,b)}),c.call(K.selectAll(".pager .page")[0][0],0)):K.select(".pager").classed("disabled",!0)):K.select(".about").classed("disabled",!0);var f=K.select(".map");d.pic?f.attr("src",p+d.pic):f.attr("src","")}):M.on("click",null).classed("disabled",!0)}function d(){z=d3.select("#filters").selectAll(".filter").data(B).enter().append("g").attr("class","filter").attr("transform",function(a,b){return"translate("+(H[0]+(E+G)*b)+","+H[1]+")"});var a=z.append("g").attr("class","header").each(function(a){a.header=this}).on("click",function(){b.call(this),I&&k.call(I,J.prop)});a.append("rect").attr("width",E).attr("height",F),a.append("text").attr("x",10).attr("y",19).text(function(a){return a.title}),A=z.append("g").attr("class","points").attr("transform","translate(0,"+(F+C)+")")}function e(){var b=d3.select(this).datum();A.each(function(c,d){for(var e=d3.nest().key(function(a){return a.tag}).entries(b[c.prop]),f=[],g=0;g<e.length;g++)f=f.concat(e[g].values);var h=d3.select(this).selectAll(".filter-point").data(f,function(a){return a.id});h.enter().append("rect").attr("x",function(a){return a.position[0]-H[0]-d*(E+G)}).attr("y",function(a){return a.position[1]-H[1]-(20+C)}).attr("class","filter-point").attr("width",x).attr("height",x).attr("fill",function(a){return q[a.tag]}).on("click",function(b){a.call(b.mapPoint[0][0],b)}).on("mouseover",function(a){var b=d3.mouse(d3.select(".content")[0][0]);L.text(a.title).style("left",b[0]+N+"px").style("top",b[1]+N+"px").classed("disabled",!1)}).on("mouseout",function(){L.classed("disabled",!0)}),h.transition().duration(function(){return 300+200*Math.random()}).attr("x",function(a,b){return b%D*(x+C)+"px"}).attr("y",function(a,b){return parseInt(b/D)*(x+C)+"px"}).style("opacity",1),h.exit().transition().duration(function(){return 300+200*Math.random()}).attr("x",function(){return-500+2e3*Math.random()}).attr("y",function(){return-500+1e3*Math.random()}).style("opacity",0).remove()})}function f(a){_.each(a,function(a){_.each(a.approveList,function(b){b.approvedList.push(a)}),_.each(a.negativeList,function(b){b.negativedList.push(a)})})}function g(a){_.each(a,function(b){if(b.approveList.length>0)b.negativeList=h(a,b.approveList,b.id);else if(b.negativeList.length>0)b.approveList=h(a,b.negativeList,b.id);else if(-1!=b.tag.indexOf("na")){var c=[];_.each(a,function(a){-1!=a.tag.indexOf("un")&&b.id!=a.id&&c.push(a)}),b.negativeList=c}})}function h(a,b,c){var d=[],e=0;for(a.length;e<a.length;e++){var f=a[e],g=!0;if(-1!=f.tag.indexOf("un")&&f.id!=c){for(var h=0,i=b.length;i>h;h++)if(f.id==b[h].id){g=!1;break}g&&d.push(f)}}return d}function i(a,b){return _.each(a,function(c,d){var e=_.findWhere(b,{id:c});e?a[d]=e:console.log(a,c)}),a}function j(a){var b=[];return _.each(a,function(a){_.each(a.borderList,function(c){for(var d=!0,e=0;e<b.length;e++){{b[e]}if(b[e][0]==c.id&&b[e][1]==a.id||b[e][0]==a.id&&b[e][1]==c.id){d=!1;break}}d&&b.push([a,c])})}),b}function k(a){var b=this.datum();w.html("").selectAll("line").data(b[a]).enter().append("line").attr("class","approve-line").attr("x1",b.position[0]+y).attr("x2",function(a){return parseInt(a.mapPoint.attr("x"))+y}).attr("y1",b.position[1]+y).attr("y2",function(a){return parseInt(a.mapPoint.attr("y"))+y})}function l(){u.html("").selectAll("line").data(t).enter().append("line").attr("class","border-line").attr("x1",function(a){return parseInt(a[0].mapPoint.attr("x"))+y}).attr("x2",function(a){return parseInt(a[1].mapPoint.attr("x"))+y}).attr("y1",function(a){return parseInt(a[0].mapPoint.attr("y"))+y}).attr("y2",function(a){return parseInt(a[1].mapPoint.attr("y"))+y})}g3.initContent({contentWidth:1280,contentHeight:720,domain:"lenta.ru",debugMode:!0});var m,n,o,p="img/maps/",q={un:"#A1A4A7",unna:"#FFC519",na:"#F3740D"},r=null,s=null,t=null,u=d3.select("#borders"),v=d3.selectAll("#rects rect"),w=d3.select("#links"),x=5,y=x/2,z=null,A=null,B=[{title:"Кто признаёт",prop:"approveList"},{title:"Кто не признаёт",prop:"negativeList"},{title:"Кого признаёт",prop:"approvedList"},{title:"Кого не признаёт",prop:"negativedList"}],C=2,D=20,E=(x+C)*D-C,F=30,G=30,H=[1280-B.length*(E+G)+40-G-F-G,20],I=null,J=null,K=d3.select(".problem-popup"),L=d3.select(".popup"),M=d3.select(".na-info.btn"),N=10,O=30,P=30,Q=d3.select(".about-methods");d3.select(".about-methods-btn").on("click",function(){Q.classed("disabled",!Q.classed("disabled"))}),Q.on("click",function(){Q.classed("disabled",!0)}),K.on("click",function(){K.classed("disabled",!0)});var R=d3.select(".country-list"),S=R.select(".text");d3.tsv("data.csv",function(b){r=b,d3.tsv("problems.csv",function(c){_.each(r,function(a){a.mapPoint=d3.select("#"+a.id),a.mapPoint.datum(a).style("fill",q[a.tag.toLowerCase()]),a.position=[+a.mapPoint.attr("x"),+a.mapPoint.attr("y")],a.tag=a.tag.toLowerCase(),a.borderList=a.borderList?i(a.borderList.replace(/\s{1,}/g,"").split(","),r):[],a.approveList=a.approveList?i(a.approveList.replace(/\s{1,}/g,"").split(","),r):[],a.negativeList=a.negativeList?i(a.negativeList.replace(/\s{1,}/g,"").split(","),r):[],a.approvedList=[],a.negativedList=[]}),g(r),f(r),_.each(c,function(a){a.desc=a.desc.split("///"),a.square=+a.square,a.metropolisSquare=+a.metropolisSquare,a.population=+a.population,a.metropolisPopulation=+a.metropolisPopulation,a.squarePercent=a.metropolisSquare?a.square/a.metropolisSquare:null,a.populationPercent=a.metropolisPopulation?a.population/a.metropolisPopulation:null;var b=_.findWhere(r,{id:a.id});b?b.problem=a:console.log("problem id = ",a.id)}),t=j(r),s=d3.nest().key(function(a){return a.tag}).entries(r);var d=R.select(".list").selectAll(".line").data(b).enter().append("div").attr("class",function(a){return"line disabled "+a.tag}).text(function(a){return a.title}).on("click",function(b){return a.call(b.mapPoint[0][0],b)});d3.select("body").on("click",function(){d.classed("disabled",!0)}),S.on("click",function(){this.value=""}).on("keyup",function(){var a=this.value.toLowerCase();d.classed("disabled",function(b){return-1==b.title.toLowerCase().indexOf(a)})}),console.log(b),v.on("click",function(b){a.call(this,b)}).on("mouseover",function(a){var b=d3.mouse(this);L.text(a.title).style("left",b[0]+N+"px").style("top",b[1]+N+"px").classed("disabled",!1)}).on("mouseout",function(){L.classed("disabled",!0)}),l()}),_.filter(r,function(a){"na"!=a.tag||a.problem||console.log("na country dont't have problem set",a.title)})}),d(),b.call(B[0].header)}();